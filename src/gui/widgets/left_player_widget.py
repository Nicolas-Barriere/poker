...
class LeftPlayerWidget(QWidget):
    def __init__(self, player, joueur_idx, main_window, hand_widget, parent=None):
        ...
        layout.addWidget(betzone_box_w, alignment=Qt.AlignLeft)
        ...
        layout.addWidget(jetons_box_w, alignment=Qt.AlignLeft)
        ...
        if player.in_game:
            layout.addWidget(hand_widget(player.cards), alignment=Qt.AlignLeft | Qt.AlignBottom)
        else:
            layout.addWidget(QLabel("(Couché)"), alignment=Qt.AlignLeft | Qt.AlignBottom)
